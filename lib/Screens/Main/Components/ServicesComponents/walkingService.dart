...
class WalkingService extends StatefulWidget {
  const WalkingService({Key? key}) : super(key: key);

  @override
  State<WalkingService> createState() => _WalkingServiceState();
}

class _WalkingServiceState extends State<WalkingService> {
  ...
  Future writeData() async {
    try {
      getData();
      final doc =
      FirebaseFirestore.instance.collection("walkService").doc(user?.uid);
